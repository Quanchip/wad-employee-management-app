...
import { FaTachometerAlt, FaUser, FaBuilding, FaCalendarAlt, FaMoneyBillWave, FaAd, FaCog } from 'react-icons/fa'; // ✅ Imported icons
    ...
    return ( 
        <div className="bg-gray-900 text-white h-screen w-64 fixed left-0 top-0">  
            ...
            <nav className="flex flex-col space-y-4 mt-4"> 
                ...
                <NavLink to="/admin-dashboard/salary/add" className= {({isActive}) => `${isActive ? "bg-blue-500" : " "} flex items-center space-x-2 p-3 rounded-md hover:bg-gray-700`}
                    end>
                    <FaMoneyBillWave className="text-lg" />
                    <span>Salary</span>
                </NavLink>

                <NavLink to="/admin-dashboard/setting" className= {({isActive}) => `${isActive ? "bg-blue-500" : " "} flex items-center space-x-2 p-3 rounded-md hover:bg-gray-700`}
                    end>
                    <FaCog />
                    <span>Settings</span>
                </NavLink>
